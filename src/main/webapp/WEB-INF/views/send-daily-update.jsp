...
<div id="container">
    <div id="subcontainer">
        ...
        <div id="pagecontainer">
            <div class="page">
            <h2>Send Daily Updates</h2>
  

	<form:form method="POST" action="${pageContext.request.contextPath}/daily-update.do" commandName="dailyUpdateDto" >
		<table>
			<tr>
				<td>Catalogue Id</td>
				<td><input id="catalogueId" type="text" class="form-control" name="catalogueId" /></td>
				<td><form:errors path="catalogueId" cssStyle="color: #ff0000;"/></td>
			</tr>
