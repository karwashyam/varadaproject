...
<div id="container">
    <div id="subcontainer">
        ...
        <div id="pagecontainer">
            <div class="page">
            <h2>Send Message</h2>
            <p>Enter "all" in userId for sending general message to every user 

	<form:form method="POST" action="${pageContext.request.contextPath}/send-message.do" commandName="sendMessageDto" >
		<table>
			<tr>
				<td>User Id</td>
				<td><input id="userId" type="text" class="form-control" name="userId" /></td>
