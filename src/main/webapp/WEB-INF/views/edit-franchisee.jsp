          ...
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form:form name="franchiseSchFrm" id="franchiseSchFrm" class="form-horizontal form-label-left" method="POST" action="${pageContext.request.contextPath}/franchisee/edit-franchisee" commandName="franchiseModel" >
