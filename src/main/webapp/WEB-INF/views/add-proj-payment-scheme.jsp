        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                	<div class="x_title">
                    <h2>Add Project Payment Scheme</h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form:form name="projPaymentSchFrm" id="projPaymentSchFrm" class="form-horizontal form-label-left" method="POST" action="${pageContext.request.contextPath}/proj-payment-scheme/add" commandName="projectPaymentSchemeDto" >
